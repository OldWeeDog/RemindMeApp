...
public class CreateList extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    /*
    Adding code for the save and load buttons
     */

    /* Setting variables for items created in the activity_create.xml */
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        */
        ...
        FileHelper.writeData(items, this);
         ...
         Toast creates a pop- up that notifies the user that the item has been deleted
